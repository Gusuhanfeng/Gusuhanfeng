...
Building an edge-first tennis analysis prototype that turns video evidence into explainable coaching feedback.
...
Built core systems for trusted AI twins and multi-agent collaboration, from reliable runtime behavior to production delivery.
